...
<div class="container">
          <div class="section">
           ...
           <div class="col-md-12">
              	<h5 class="header">Shipping configuration<a href="addshipconfig?v=0" class="right btn font-12">Create New</a></h5>
			</div> 
			</div>
             
              <div class="row">
                <div class="col s12 m12">
                  <table id="shipconfigDT" class=" responsive-table display ourstyletable" cellspacing="0">
