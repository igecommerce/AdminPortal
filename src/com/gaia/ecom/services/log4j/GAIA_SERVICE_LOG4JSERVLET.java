package com.gaia.ecom.services.log4j;
...
@WebServlet(name="Log4jServlet",urlPatterns={"/Log4jServlet"},
initParams={@WebInitParam(name="log4j-properties-location",value="WEB-INF/log4j.properties")},
loadOnStartup=0)
public class GAIA_SERVICE_LOG4JSERVLET extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
	
	private final static Logger log= Logger
			.getLogger(GAIA_SERVICE_LOG4JSERVLET.class);
