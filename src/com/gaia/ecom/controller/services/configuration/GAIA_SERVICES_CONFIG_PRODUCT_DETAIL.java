...
public class GAIA_SERVICES_CONFIG_PRODUCT_DETAIL implements Serializable {
	...
	public String getPrecategoryname() {
		return precategoryname;
	}
	public void setPrecategoryname(String precategoryname) {
		this.precategoryname = precategoryname;
	}
