...
public class GAIA_SERVICES_CONFIG_CATEGORY_DETAIL implements Serializable {
	...
	private String baseategory;
	private String precategory;
	private String parentid;
	private String descbanner;
	
	public String getDescbanner() {
		return descbanner;
	}

	public void setDescbanner(String descbanner) {
	...
	public String getBaseategory() {
		return baseategory;
	}

	public void setBaseategory(String baseategory) {
		this.baseategory = baseategory;
	}
